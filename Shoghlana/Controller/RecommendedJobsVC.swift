...
class RecommendedJobsVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
    
    
    @IBOutlet weak var jobsTableView: UITableView!
    
    @IBOutlet weak var careerAlertView: UIView!
    ...
    override func viewDidLoad() {
        ...
        DesignableViews.viewBorderColor(view: careerAlertView, cornerRadius: 5, borderColor: viewBorderColor.cgColor, borderWidth: 2)
    ...
    func getRecommendedJobs(){
        self.activityIndicatorView.startAnimating()
        JobsModelRequest().recommendedJobs(controller: self, apiTitle: "Recommended Jobs", view: self.view) { (jobsModel) in
